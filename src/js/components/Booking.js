...
export class Booking {
  ...
  initTables(event){
    ...
    if(!clickedElement.matches(select.booking.tables)){
      return;
    }
    ...
    if(clickedElement.classList.contains(classNames.booking.tableBooked)){
      alert('Ten stolik jest już zajęty w wybranym terminie. Wybierz inny stolik lub zmień datę/godzinę.');
      return;
    }
